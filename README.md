...
const pujas = {
    location: "India 🇮🇳",
    currentFocus: ["React", "Tailwind CSS", "Data Visualization"],
    learning: ["Next.js", "TypeScript", "D3.js"],
    hobbies: ["Coding", "Design", "Creating Beautiful UIs"],
    funFact: "I turn data into stories and code into art! 🎨"
};
```

- 🔭 I'm currently working on **interactive data visualization projects**
- 🌱 I'm currently learning **advanced React patterns and D3.js**
- 💬 Ask me about **React, Tailwind CSS, Chart.js, or UI/UX design**
- ⚡ Fun fact: **I believe every pixel matters!**
...
const myAchievements: Achievements = {
  ...
  technologiesMastered: ["React", "Tailwind", "JavaScript", "CSS"],
  coffeeConsumed: "∞",
  linesOfCode: "10,000+"
};
```
...
- 🎨 Building interactive data visualization components with React and D3.js
- 🚀 Creating reusable UI component libraries with Tailwind CSS
- 📊 Exploring advanced charting techniques and animations
